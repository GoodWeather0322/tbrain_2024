...
from tbrain_v7.dataloader import DataLoader as DataLoaderV7
from tbrain_v3.dataloader import DataLoader as DataLoaderV3
from tbrain_v7.retriever import Retriever
from tbrain_v7.scorer import Scorer
from tbrain_v3.settings import settings as settings_v3
from tbrain_v7.settings import settings

if __name__ == "__main__":

    settings.output_dir = Path(settings.output_dir) / "v7"
    ...
    for alpha in np.arange(0.00, 0.50, 0.01):
        ...
        # v7
        dataloaderv7 = DataLoaderV7()
        questions, related_corpus_ids = dataloaderv7.load_dataset()
        questions_bm25, dataset_bm25 = dataloaderv7.preprocess_dataset(
